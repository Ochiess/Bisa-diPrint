            ...
            <div class="content d-flex flex-column justify-content-center">
              <div class="row">
                <div class="col-md-6 icon-box" data-aos="fade-up">
                  ...
                  <h4>Cetak Dokumen</h4>
                  <p>Pelanggan dapat menggunakan fitur ini untuk berbagai kebutuhan cetak mencetak dokumen</p>
                </div>
                <div class="col-md-6 icon-box" data-aos="fade-up" data-aos-delay="200">
                  <i class="bx bx-images"></i>
                  <h4>Cetak Foto</h4>
                  <p>Selain cetak dokumen, pelanggan juga dapat melakukan pemesanan cetak foto</p>
                </div>
                <div class="col-md-6 icon-box" data-aos="fade-up" data-aos-delay="100">
                  <i class="bx bx-cube-alt"></i>
                  <h4>Sablon Baju</h4>
                  <p>Pelanggan dapat menggunakan layanan ini untuk kebutuhan sablon baju</p>
                </div>
                <div class="col-md-6 icon-box" data-aos="fade-up" data-aos-delay="500">
                  <i class="bx bx-id-card"></i>
                  <h4>Cetak Spanduk</h4>
                  <p>Layanan berupa jasa pencetakan spanduk atau baliho</p>
                </div>
              </div>
            </div>
          </div>
          ...
          <div class="col-lg-6">
            <div class="row">
              <div class="col-lg-6 info" data-aos="fade-up">
                <i class="bx bx-map"></i>
                <h4>Alamat</h4>
                <p>Villa Samata Sejahtera, jl. Syahrul Yasin Limpo Kab. Gowa</p>
              </div>
              <div class="col-lg-6 info" data-aos="fade-up" data-aos-delay="100">
                <i class="bx bx-phone"></i>
                <h4>Kontak</h4>
                <p>wa : 085242883982<br>Hp : 082159024785</p>
              </div>
              <div class="col-lg-6 info" data-aos="fade-up" data-aos-delay="200">
                <i class="bx bx-envelope"></i>
                <h4>Email</h4>
                <p>sriasriani135@gmail.com<br>60900116068@uin-alauddin.ac.id</p>
              </div>
